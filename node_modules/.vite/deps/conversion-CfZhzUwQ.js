...
//#endregion
//#region node_modules/@capacitor-community/bluetooth-le/dist/esm/conversion.js
/**
...
function hexStringToDataView(hex) {
	...
	for (i = 0; i < hex.length; i++) {
		...
		if (c > 47 && c < 58 || c > 64 && c < 71 || c > 96 && c < 103) {
			...
			if (isEmpty ^= 1) bin.push(buffer & 255);
		}
	}
...
function webUUIDToString(uuid) {
	...
	else if (typeof uuid === "number") return numberToUUID(uuid);
...
function toHexString(value) {
	if (value === void 0) return;
	if (value instanceof DataView) return dataViewToHexString(value);
...
//#endregion
export { mapToObject as a, textToDataView as c, toUint8Array as d, webUUIDToString as f, registerPlugin as h, hexStringToDataView as i, toArrayBufferDataView as l, WebPlugin as m, dataViewToNumbers as n, numberToUUID as o, Capacitor as p, dataViewToText as r, numbersToDataView as s, dataViewToHexString as t, toHexString as u };

//# sourceMappingURL=conversion-CfZhzUwQ.js.map